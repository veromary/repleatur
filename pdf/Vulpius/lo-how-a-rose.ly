...
\header {
  title = \markup \override #'(font-name . "Linux Libertine O") \fontsize #3 "Lo, How a Rose"
...
lyrIc = \lyricmode {
 ...
 came a flow'r -- et bright
 a -- midst the cold of win -- ter
...
\score {
  ...
  \header {
    poet = "Theodore Baker and Rev. George R. Woodward"
...
\markup \justify-line \fontsize #1.5 {
  \strut
  \line {
    \bold "2" 
    \left-column {
"This plant, with blossom laden,"
